...
const DICT = {
  fr: {
    ...
    'card.system': 'Système',
    'field.port': 'Port',
    'field.bindAddress': 'Adresse d\'écoute',
    'bind.local': 'Local uniquement (recommandé)',
    'bind.all': 'Tout le réseau',
    'field.authToken': 'Jeton d\'accès web',
    'btn.copy': 'Copier',
    'btn.regenerate': 'Régénérer',
    'hint.authToken': 'Jeton requis pour ouvrir le dashboard web (menu du tray). Régénérez-le s\'il est compromis — tous les clients WebSocket seront déconnectés.',
    'field.masterToken': 'Jeton du maître',
    'hint.masterToken': 'Jeton d\'accès web du maître (Paramètres → Options du maître). Requis en mode esclave depuis la version 2026.08.045.',
    ...
    'field.autoUpdate': 'Télécharger automatiquement les nouvelles versions',
    'btn.updateNow': 'Mettre à jour maintenant',
    'btn.showDetails': 'Détails des versions',
  ...
  en: {
    ...
    'field.autoUpdate': 'Download new versions automatically',
    'btn.updateNow': 'Update now',
    'btn.showDetails': 'Version details',
    ...
    'bar.both': 'Both',
    'field.port': 'Port',
    'field.bindAddress': 'Listen address',
    'bind.local': 'Local only (recommended)',
    'bind.all': 'Whole network',
    'field.authToken': 'Web access token',
    'btn.copy': 'Copy',
    'btn.regenerate': 'Regenerate',
    'hint.authToken': 'Token required to open the web dashboard (tray menu). Regenerate if compromised — all WebSocket clients will be disconnected.',
    'field.masterToken': 'Master token',
    'hint.masterToken': 'Master web access token (Settings → Master options). Required in slave mode since 2026.08.045.',
